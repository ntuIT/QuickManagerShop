...
@Embeddable
public class DiscountTypePo implements Serializable {

    private static final long serialVersionUID = -1326477212674314675L;
    ...
    public DiscountTypePo() {
        super();
    }

    public DiscountTypePo(Long id, String name, String description, String code, Date createdAt, Date updatedAt) {
        super();
        this.id = id;
        this.name = name;
